...
proj_idx = get_tailwind_head("Projects", 1) + get_header(1, 'projects') + '''
    <main class="flex-grow max-w-5xl mx-auto px-4 sm:px-6 py-20">
        ...
        <section class="mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                    ...
                    <a href="./market-tracker/index.html" class="text-accent font-medium hover:underline mt-auto">View Project &rarr;</a>
                </div>
                <!-- Project -->
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                    ...
                    <span class="text-gray-400 font-medium mt-auto cursor-not-allowed">Migrating soon</span>
                </div>
            </div>
        </section>
        ...
        <section class="mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                    ...
                    <p class="text-secondary text-sm mb-4 flex-grow">Lightweight tool to search and explore GitHub user profiles and public repositories.</p>
                    <a href="./github-profile-finder/index.html" class="text-accent font-medium hover:underline mt-auto">View App &rarr;</a>
                </div>
                <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow flex flex-col">
                    <h3 class="text-xl font-bold text-primary mb-2">News Headlines App</h3>
                    <p class="text-secondary text-sm mb-4 flex-grow">Aggregates live news headlines across categories using a public news API.</p>
